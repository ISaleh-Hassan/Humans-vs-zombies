	...
	void CreateDummyDataForDatabase() {
		...
		for (int i = 0; i < numberOfGames; i++) {		
			...
			for (int m = 0; m < numberOfMissions; m++) {
				if (m == 0) {
					mc.addMission(new Mission("ZOMBIE Mission: " + (m + 1), new String("Zombie Description"), Faction.ZOMBIE, new Point(10, 10), Timestamp.valueOf("2000-01-10 01:01:01"), Timestamp.valueOf("2020-12-12 01:59:59")), gId);
				} else if (m == 1) {
					mc.addMission(new Mission("HUMAN Mission: " + (m + 1), new String("Human Description"), Faction.HUMAN, new Point(10, 10), Timestamp.valueOf("2000-01-10 01:01:01"), Timestamp.valueOf("2020-12-12 02:30:00")), gId);
				} else {
					mc.addMission(new Mission("ALL Mission: " + (m + 1), new String("All Description"), Faction.ALL, new Point(10, 10), Timestamp.valueOf("2000-01-10 04:04:04"), Timestamp.valueOf("2020-12-12 05:05:05")), gId);
				}
			}
