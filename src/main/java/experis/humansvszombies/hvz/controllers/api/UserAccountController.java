...
public class UserAccountController {
    ...
    public ResponseEntity<UserAccountObject> loginUser(@RequestBody UserAccount userAccount) {
        ...
        try {
            ...
            if (userAccount != null) {
                if (user == null) {
                    // Compare supplied phone number to account phone number and return SUCCESS
                    // message if login information is correct.
                    if (userPhone.getPhoneNumber().equals(userAccount.getPhoneNumber())) {
                        status = HttpStatus.OK;
                        userInfo = new UserAccountObject(userPhone.getUserAccountId(), null, null,
                                userPhone.getUserType(), userPhone.getUsername(), null, null,
